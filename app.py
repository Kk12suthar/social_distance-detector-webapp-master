...
from counting_people import motion_detection, social_distance_detector, people_counter

sys.path.append("counting_people.py")
...
users = []
users.append(User(id=1, username='admin', password='kishor'))
users.append(User(id=2, username='admin2', password='kartik'))
users.append(User(id=3, username='user', password='lalit'))
